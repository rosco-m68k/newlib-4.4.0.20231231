...
.go_on:
  ...
  ; At least bra would be faster than bsr for the _returnFromException call...

  clr.l   (a7)                            ; idk why we clear this rather than popping it 🤷
  bsr     _returnFromException            ; idk why this isn't just a bra / jmp either 🤨



; ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; /*
;  * _remcomHandler is a front end for handle_exception.  It moves the
...
_remcomHandler::
  ...
  bsr     _handle_exception               ; (original comment - this never returns)
